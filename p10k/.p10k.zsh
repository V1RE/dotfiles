# Generated by Powerlevel10k configuration wizard on 2022-01-30 at 17:15 CET.
...
# no frame, sparse, many icons, concise, instant_prompt=auto-quiet.
...
() {
  ...
  #
  typeset -g POWERLEVEL9K_DIR_CLASSES=(
    '~/Code/Socialbrothers(|/*)' WORK     ''
    '~/Code(|/*)'                CODE     ''
    #     '~(|/*)'       HOME     ''
    #     '*'            DEFAULT  ''
  )

  typeset -g POWERLEVEL9K_DIR_WORK_VISUAL_IDENTIFIER_EXPANSION='%5F'
  typeset -g POWERLEVEL9K_DIR_CODE_VISUAL_IDENTIFIER_EXPANSION='%2F'
  ...
  ###[ package: name@version from package.json (https://docs.npmjs.com/files/package.json) ]####
  # Package color.
  typeset -g POWERLEVEL9K_PACKAGE_FOREGROUND=15
  typeset -g POWERLEVEL9K_PACKAGE_BACKGROUND=8
